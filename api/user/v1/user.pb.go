...
var file_api_user_v1_user_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x32, 0xd1, 0x02, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x38, 0x0a, 0x08,
	...
	0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x32, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x56, 0x0a, 0x14, 0x47, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x61,
	0x6d, 0x65, 0x12, 0x24, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d,
	...
	0x6c, 0x79, 0x12, 0x4a, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x42, 0x79, 0x49, 0x64, 0x12, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	...
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x36,
...
var file_api_user_v1_user_proto_goTypes = []interface{}{
	...
	(*RegisterModel)(nil),               // 8: user.v1.RegisterModel
	(*Profile)(nil),                     // 9: user.v1.Profile
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	7, // 0: user.v1.UserReply.user:type_name -> user.v1.User
	8, // 1: user.v1.RegisterRequest.user:type_name -> user.v1.RegisterModel
	9, // 2: user.v1.GetProfileReply.profile:type_name -> user.v1.Profile
	...
	1, // 8: user.v1.Users.Register:output_type -> user.v1.UserReply
	1, // 9: user.v1.Users.Login:output_type -> user.v1.UserReply
	5, // 10: user.v1.Users.GetProfileByUserName:output_type -> user.v1.GetProfileReply
	5, // 11: user.v1.Users.GetProfileById:output_type -> user.v1.GetProfileReply
	1, // 12: user.v1.Users.GetUser:output_type -> user.v1.UserReply
