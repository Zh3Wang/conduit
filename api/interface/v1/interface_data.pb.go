...
type SingleArticle struct {
	...
	Author         *SingleArticleAuthorInfo `protobuf:"bytes,10,opt,name=author,proto3" json:"author,omitempty"`
}
...
func (x *SingleArticle) GetAuthor() *SingleArticleAuthorInfo {
	if x != nil {
		return x.Author
	}
	return nil
...
type SingleArticleAuthorInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SingleArticleAuthorInfo) Reset() {
	*x = SingleArticleAuthorInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *SingleArticleAuthorInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SingleArticleAuthorInfo) ProtoMessage() {}

func (x *SingleArticleAuthorInfo) ProtoReflect() protoreflect.Message {
	mi := &file_api_interface_v1_interface_data_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SingleArticleAuthorInfo.ProtoReflect.Descriptor instead.
func (*SingleArticleAuthorInfo) Descriptor() ([]byte, []int) {
	return file_api_interface_v1_interface_data_proto_rawDescGZIP(), []int{0, 0}
}

func (x *SingleArticleAuthorInfo) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *SingleArticleAuthorInfo) GetBio() string {
	if x != nil {
		return x.Bio
	}
	return ""
...
func (x *SingleArticleAuthorInfo) GetImages() string {
	if x != nil {
		return x.Images
	}
	return ""
...
func (x *SingleArticleAuthorInfo) GetFollowing() bool {
	if x != nil {
		return x.Following
	}
	return false
...
var file_api_interface_v1_interface_data_proto_rawDesc = []byte{
	...
	0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x03, 0x0a, 0x0d, 0x53, 0x69, 0x6e, 0x67,
	...
	,
...
var file_api_interface_v1_interface_data_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_interface_v1_interface_data_proto_goTypes = []interface{}{
	(*SingleArticle)(nil),           // 0: SingleArticle
	(*SingleArticleAuthorInfo)(nil), // 1: SingleArticle.authorInfo
}
var file_api_interface_v1_interface_data_proto_depIdxs = []int32{
	1, // 0: SingleArticle.author:type_name -> SingleArticle.authorInfo
...
func file_api_interface_v1_interface_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_interface_v1_interface_data_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SingleArticleAuthorInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
